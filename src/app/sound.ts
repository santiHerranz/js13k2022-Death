...
export const sounds = {
  ...
  HEART: () => play(10, 0.4, () => {
    zzfx(1.02, .05, 288, .02, .07, .15, 2, .87, -4.6, 0, -317, .04, 0, 0, 0, 0, 0, .71, .03, 0)
  }),
  DIAMOMD: () => play(10, 0.4, () => {
  ...
  CLICK: () => zzfx(.5, .4, 358, .01, .01, .01, 2, .61, 12, -13, 96, .08, 0, 0, 0, 0, 0, .31, .01, .09),
...
export const audioMode = { mode: 1 }

function play(index: number, t: number = 0.3, callback: any) {

  if (audioMode.mode == 2) return
